...
static public class Extensions_Sprite
{
    ...
    static public Color PositionToPixelColor(this Sprite @this, Vector3 a, Transform b = null)
    {
    ...
    static public float PositionToPixelAlpha(this Sprite @this, Vector3 a, Transform b = null)
    => @this.PositionToPixelColor(a, b).a;
    /// <summary> Returns position of pixel a, transformed by b. </summary>
    static public Vector3 PixelCoordsToPosition(this Sprite @this, Vector2 a, Transform b = null)
    {
